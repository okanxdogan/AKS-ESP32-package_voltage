...
#define CBMS_ID_STATUS    (CBMS_BASE_ID + 0x00)
...
class CanSniffer {
   ...
   private:
    void setupInterface();
    bool initMCP();
    void printRawFrame(uint32_t id, bool isExtended, uint8_t dlc, const unsigned char* buf);
    ...
    unsigned long lastVoltPrintTime;
};
